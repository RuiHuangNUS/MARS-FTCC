...
if("TRUE" STREQUAL "TRUE")
  set(plan_manager_SOURCE_PREFIX /home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/src/plan_manager)
  set(plan_manager_DEVEL_PREFIX /home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/devel)
  ...
  set(plan_manager_INSTALL_PREFIX /home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/install)
...
if(NOT "/home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/src/plan_manager/include " STREQUAL " ")
  set(plan_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/src/plan_manager/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plan_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/src/plan_manager/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;utils;swept_volume;planner_algorithm")
