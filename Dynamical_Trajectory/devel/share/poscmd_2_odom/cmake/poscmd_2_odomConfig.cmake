...
if("TRUE" STREQUAL "TRUE")
  set(poscmd_2_odom_SOURCE_PREFIX /home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/src/uav_simulator/fake_drone)
  set(poscmd_2_odom_DEVEL_PREFIX /home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/devel)
  ...
  set(poscmd_2_odom_INSTALL_PREFIX /home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'poscmd_2_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hr/GitHub/MARS-FTCC/Dynamical_Trajectory/src/uav_simulator/fake_drone/${idir}'.  ${_report}")
    endif()
