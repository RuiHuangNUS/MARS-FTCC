...
#define CIRCLE_EDGE_NUM 30
    ...
    class sdSquare : public BasicShape
    {
    public:
    // 1.0,3.0,2.0
        const  Eigen::RowVector2d b{1.8,1.8};
        Eigen::RowVector3d trans{Eigen::RowVector3d::Zero()};
        Eigen::Matrix3d Rotate{Eigen::Matrix3d::Identity()};
        sdSquare(const Config &conf) : BasicShape(conf)
        {
            getTransform(Rotate, trans);
            std::cout << "======Rotation:" << Rotate << "======" << std::endl;
            std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
    ...
    public:
        typedef std::shared_ptr<sdSquare> Ptr;
    ...
    */
    class sdRectangle0 : public BasicShape
    {
        public:
            const  Eigen::Vector2d wh{2.8,1.4};
            ...
            // Eigen::Matrix3d Rotate{Eigen::Matrix3d::Identity()};
            // double angle = M_PI / 4;
            // Eigen::Matrix3d Rotate = Eigen::AngleAxisd(angle, Eigen::Vector3d::UnitZ()).toRotationMatrix();

        
            sdRectangle0(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<sdRectangle0> Ptr;
    ...
    /*
        ...
        ···
     */
    class sdRectangle90 : public BasicShape
    {
        public:
            const  Eigen::Vector2d wh{2.8,1.4};
            ...
            sdRectangle90(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<sdRectangle90> Ptr;
    ...
    /*
        ...
        ···
     */
    class sdRectangle45 : public BasicShape
    {
        public:
            const  Eigen::Vector2d wh{2.8,1.4};
            ...
            sdRectangle45(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<sdRectangle45> Ptr;
    ...
    class MARS3x2 : public BasicShape
    {
        public:
            ...
            MARS3x2(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<MARS3x2> Ptr;
    ...
    class sdRectangleLong0 : public BasicShape
    {
        public:
            const  Eigen::Vector2d wh{2.4,0.6};
            ...
            sdRectangleLong0(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<sdRectangleLong0> Ptr;
    ...
    // zhang added
    class sdRectangleLong90 : public BasicShape
    {
        public:
            const  Eigen::Vector2d wh{2.4,0.6};
            ...
            sdRectangleLong90(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<sdRectangleLong90> Ptr;
    ...
    // zhang added
    class sdRectangleLong45 : public BasicShape
    {
        public:
            const  Eigen::Vector2d wh{2.4,0.6};
            // const  Eigen::Vector2d wh{0.6,2.4};
            ...
            sdRectangleLong45(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<sdRectangleLong45> Ptr;
    ...
    // zhang added
    class Lthick : public BasicShape
    {
        public:
            const  Eigen::Vector2d wh{2.2,2.2};
            Eigen::RowVector3d trans{Eigen::RowVector3d::Zero()};
            Eigen::Matrix3d Rotate{Eigen::Matrix3d::Identity()};
            Lthick(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<Lthick> Ptr;
