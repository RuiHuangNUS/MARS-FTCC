...
public:
    ...
    std::map<std::string, std::function<BasicShape *(const Config &)>> shapeConstructors = {
        ...
        {"sdRectangle2", [](const Config &conf)
         { std::cout << "\033[35m=======sdRectangle2======= "<< "\033[0m" << std::endl;
        return new sdRectangle2(conf); }},
...
public:
    ...
    {
        std::ofstream file;
        file.open("/home/zhang/Implicit-SVSDF-Planner/src/yaw_trans_data.csv", std::ios::out | std::ios::app); // Open in append mode
