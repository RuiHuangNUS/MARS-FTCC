...
#define CIRCLE_EDGE_NUM 30
    ...
    class sdRectangle : public BasicShape
    {
    public:
    // 1.0,3.0,2.0
        ...
        Eigen::RowVector3d trans{Eigen::RowVector3d::Zero()};
        Eigen::Matrix3d Rotate{Eigen::Matrix3d::Identity()};
        sdRectangle(const Config &conf) : BasicShape(conf)
        {
            getTransform(Rotate, trans);
            std::cout << "======Rotation:" << Rotate << "======" << std::endl;
            std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
    ...
    public:
        typedef std::shared_ptr<sdRectangle> Ptr;
    ...
    class sdRectangle2 : public BasicShape
    {
        public:
            const  Eigen::Vector2d wh{2.8,1.4};
            Eigen::RowVector3d trans{Eigen::RowVector3d::Zero()};
            Eigen::Matrix3d Rotate{Eigen::Matrix3d::Identity()};
            sdRectangle2(const Config &conf) : BasicShape(conf)
            {
                getTransform(Rotate, trans);
                std::cout << "======Rotation:" << Rotate << "======" << std::endl;
                std::cout << "======trans:" << trans.transpose() << "======" << std::endl;
        ...
        public:
            typedef std::shared_ptr<sdRectangle2> Ptr;
